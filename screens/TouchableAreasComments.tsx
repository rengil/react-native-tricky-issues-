...
export const content = {
  keyboard: {
    title: 'TouchableAreas Comments',
    contents: [
      'Whenever you use not a button for clicks. Think about where to click',
      'Lots of times we use texts',
      'Lots and lots we use icons',
      'Take the habit to test the app with your hand, clicking. swiping',
      'Another loving thing, there may be difference between android and ios in this things',
    ],
  },
};
...
export const TouchableAreasComments = ({ goNext }: any) => {
